...
class Rob6323Go2Env(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        rewards = {
            ...
            # "feet_clearance" : self.cfg.feet_clearance_reward_scale * rew_feet_clearance,
            "contact_force" : self.cfg.tracking_contacts_shaped_force_reward_scale * rew_tracking_contacts_shaped_force,
        }
